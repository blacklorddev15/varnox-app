...
const initializeSocket = (server) => {
  const io = new Server(server, {
    cors: {
      // Same allowlist as the REST API. https://localhost and capacitor://localhost are the
      // WebView origins of the packaged Android app; without them the socket cannot connect.
      origin: [
